...
const roleHints: Record<Role, string> = {
  ...
  client: 'Read-only portal with published documents for one site.',
}

// Roles that can be tied to a single site; others are group-wide. A supervisor
// or client must have a site; a SHEQ officer may have one (per-site officer) or
// none. The two manager roles oversee every site, so they are never site-assigned.
          ...
          <div className="w-full max-w-md rounded-2xl bg-white shadow-xl animate-scale-in">
            ...
            <div className="space-y-4 p-6">
              ...
              <div>
                ...
                <input id="u-name" className="input" placeholder="e.g. Alexis Carter" value={fullName} onChange={(e) => setFullName(e.target.value)} />
              </div>
